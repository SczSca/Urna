...
#define HOTSPOT_WIFI  "HotspotName"            /* Nombre del punto de acceso a conectarse */
#define HOTSPOT_PWD   "contraseña"                       /* Contraseña de la red */
#define MQTT_SERVER   "test.mosquitto.org"     /* Dirección del Broker MQTT */
#define MQTT_PORT     1883                     /* Puerto del Broker MQTT */
#define TXTOPIC       "votacion/colima"         /* Nombre del topic de publicación */
#define RXTOPIC       "/colima"         /* Nombre del topic de suscripción */
#define RXTOPIC1      "/colima"        /* Nombre del topic de suscripción */
